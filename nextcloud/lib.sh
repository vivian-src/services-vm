...
If you think that this is a bug, please report it to https://github.com/vivian-src/services-vm/nextcloud/issues."
        return 1
    fi
fi
...
https://github.com/vivian-src/services-vm/nextcloud"
...
# EXAMPLE: https://github.com/vivian-src/services-vm/nextcloud/pull/1012
check_if_number() {
case "${1}" in
    ''|*[!0-9]*) return 1 ;;
    *) return 0 ;;
