...
unset NCDB
    ...
    printf "Please report this to https://github.com/vivian-src/services-vm/nextcloud/issues/"
    exit 1
fi
...
Please also post this issue on: https://github.com/vivian-src/services-vm/nextcloud/issues"
        exit 1
        fi
else
msg_box "Network NOT OK. You must have a working network connection to run this script.
...
# Fixes https://github.com/vivian-src/services-vm/nextcloud/issues/58
a2dismod status
restart_webserver
...
BUGS:
Please report any bugs here: https://github.com/vivian-src/services-vm/nextcloud/issues"
