...
<html>
    ...
    <body>
        ...
        <div class="logo"></div>
        <div class="logotext">
            <h2><a href="https://github.com/vivian-src/services-vm/nextcloud" target="_blank">Nextcloud VM</a> - by <a href="https://www.hanssonit.se/nextcloud-vm/" target="_blank">T&M Hansson IT AB</a></h2>
        </div>
        <br>
